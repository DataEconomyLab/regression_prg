market = read.table("https://raw.githubusercontent.com/DataEconomyLab/regression/main/reg2020/market-1.txt", header=TRUE)
head(market)
...
super = read.table("https://raw.githubusercontent.com/DataEconomyLab/regression/main/reg2020/supermarket.txt", header=T)
head(super, 3)
